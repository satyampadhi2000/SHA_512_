...
void SHA512::process(uint64** buffer, size_t nBuffer, uint64* h){
	...
	for(size_t i=0; i<nBuffer; i++){
		...
		for(size_t j=16; j<80; j++){
			...
			std::cout<<"W"<<(j-16)<<" "<<w[j-16]<<"\n";
			std::cout<<"sig0 "<<j-15<<"-"<<sig0(w[j-15])<<"\n";
			std::cout<<"W"<<(j-7)<<" "<<w[j-7]<<"\n";
			std::cout<<"sig1 "<<j-2<<"-"<<sig1(w[j-2])<<"\n";
			std::cout<<j<<"W"<<j<<" "<<w[j]<<"\n\n";
		...
		for(size_t j=0; j<80; j++){
			...
			std::cout<<"ROTR_14_e "<<RotR(s[4], 14)<<"\n";
			std::cout<<"ROTR_18_e "<<RotR(s[4], 18)<<"\n";
			std::cout<<"ROTR_41_e "<<RotR(s[4], 41)<<"\n";
			std::cout<<"Sig1 "<<Sig1(s[4])<<"\n";

			std::cout<<"NOT_e "<<(~s[4])<<"\n";
			std::cout<<"e&f "<<(s[4]&s[5])<<"\n";
			std::cout<<"NOT_e&g "<<(~s[4]&s[6])<<"\n";
			std::cout<<"Ch_e_f_g "<<Ch(s[4], s[5], s[6])<<"\n";
			std::cout<<"t1"<<" "<<temp1<<"\n";
			...
			std::cout<<"ROTR_28_a "<<RotR(s[0], 28)<<"\n";
			std::cout<<"ROTR_34_a "<<RotR(s[0], 34)<<"\n";
			std::cout<<"ROTR_39_a "<<RotR(s[0], 39)<<"\n";
			std::cout<<"Sig0 "<<Sig0(s[0])<<"\n";

			std::cout<<"a&b "<<(s[0]&s[1])<<"\n";
			std::cout<<"a&c "<<(s[0]&s[2])<<"\n";
			std::cout<<"b&c "<<(s[1]&s[2])<<"\n";
			std::cout<<"Maj_a_b_c "<<Maj(s[0], s[1], s[2])<<"\n";
